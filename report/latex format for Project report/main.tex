...
\def\mytitle{Humor Aware Information Retrieval}
\def\myname{Rohandeep}
\def\mydegree{M.Tech CSE (Semester II)}
\def\mysupervisor{Dr. Ritesh Kumar}
\def\myrollno{PG25CS07}
\def\mydep{Computer Science and Engineering}
\def\mydegreedate{May, 2026}
\def\myexaminerone{Dr. Rachit Nimavat}
\def\myexaminertwo{Dr. Kaustubh Dhondge}
...
\begin{document}
    ...
    \include{./Formalities/acronyms}
    
    \phantomsection
    \addcontentsline{toc}{chapter}{List of Figures}
    \include{./Formalities/list_of_figures}

    \phantomsection
    \addcontentsline{toc}{chapter}{List of Tables}
    \include{./Formalities/list_of_tables}
